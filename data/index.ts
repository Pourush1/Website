...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a LLM Agentic App",
    description: "The Inside Scoop",
    className: "md:col-span-3 md:row-span-2",
    imgClassName: "absolute right-0 bottom-0 w-60 md:w-96",
  ...
  },
  {
    ...
    className: "md:col-span-3 md:row-span-1 lg:col-span-2",
    imgClassName: "",
    titleClassName: "text-center justify-center max-w-60 md:max-w-full",
    img: "",
    spareImg: "",
  },
];
